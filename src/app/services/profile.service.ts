...
import { UserCalorie } from '../models/user';
...
export class ProfileService {
  ...
  private userCalorie: AngularFirestoreDocument<UserCalorie>;
  ...
  async getUserCalorie(): Promise<Observable<UserCalorie>> {
    const user: firebase.User = await this.authService.getUser();
    this.currentUser = user;
  ...
  updateCalorie(calorie: string): Promise<void> {
